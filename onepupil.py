...
frames = '/media/grandline/ExtremeSSD/0706/July062023jf/cropped.mp4'#'/media/grandline/ExtremeSSD/EyeTracking20231116/F/cropped.mp4'
video = cv2.VideoCapture(frames)

video.set(cv2.CAP_PROP_POS_FRAMES, 1178 - 1)
...
# pupil_params = [11, 5, 150, 120]#[4, 25, 150, 160] #[3, 20, 120, 200]
