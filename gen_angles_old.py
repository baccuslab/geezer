...
h5path = '/mnt/c/Users/User/Documents/cropped77.h5'
geezr_path = '/home/yfaragal/geezer/configs/d222_calibration_jbm109.json'
...
# leds = ['cam','ne','nw','se','sw']
# with h5.File('/run/media/jerome/datum/c007_crop/c007_full_geezer.h5','r') as f:
#     print(f.keys())
#     frame_idxs = f['frame_idxs'][:]  
#     sidx = np.argsort(frame_idxs)
#     frame_idxs = frame_idxs[sidx]
...
# coordinates = coltrane.load_measurements('/home/jerome/geezer/configs/d222_calibration_jbm109.json')
# centered = coltrane.center_coordinates(coordinates)
# basis = coltrane.get_basis(centered)
